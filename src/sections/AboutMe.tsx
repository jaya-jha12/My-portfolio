...
export const About=()=>{
    return <div className="bg-[url('/bg5.png')] bg-cover bg-center flex flex-col items-center h-full w-full">
                <div className="flex  justify-center mb-10">
                    <h2 className="text-white text-5xl pt-16 pb-3 font-bold border-b-4 border-purple-500  ">
                    About Me
                    </h2>
                </div>
                ...
                <div className="flex flex-row items-center h-full">
                    <div className="flex-1 px-20 ">     
                        <img src="/photo.png" alt="Jaya" className=" w-120 h-120 aspect-square object-cover rounded-full border-4 border-purple-300 shadow-[0_0_30px_10px_rgba(192,132,252,0.5)]"></img>
                    </div>
                    <div className="">
