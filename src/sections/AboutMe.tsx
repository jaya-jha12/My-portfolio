...
export const About=()=>{
    return <div className="bg-[url('../public/bg4.png')] bg-cover bg-center flex flex-col items-center h-full w-full">
                ...
                <div className="flex flex-row items-center h-full">
                    <div className="flex-1 px-20 ">     
                        <img src="../public/photo.png" alt="Jaya" className=" w-120 h-120 aspect-square object-cover rounded-full border-4 border-purple-800 shadow-[0_0_30px_10px_rgba(192,132,252,0.5)]"></img>
                    </div>
                    <div className="">
